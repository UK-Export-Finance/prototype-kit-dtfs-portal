...
- **v01**: `/v01/dashboard-deals`, `/v01/application-details/app-details`
- **v02**: `/v02/dashboard-deals`, `/v02/application-details/app-details`
- **v03**: `/v03/dashboard-deals`, `/v03/application-details/app-details`
- **Any version**: `/{version}/dashboard-deals`, `/{version}/application-details/app-details`
...
3. Routes automatically work: `/v02/dashboard-deals`, `/v02/dashboard-facilities`, etc.

### Creating v03 folder:
1. Create `app/views/v03/` directory
2. Copy your v01 files to v03
3. Routes automatically work: `/v03/dashboard-deals`, `/v03/dashboard-facilities`, etc.

The routing system will automatically detect and handle any version folder you create!
